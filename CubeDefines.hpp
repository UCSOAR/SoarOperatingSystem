...
void cube_log(const char *format, ...);
...
// SOAR_LOG macro, prints to UART AND logs variable-length text to external flash
// Example Usage: SOAR_LOG("Sensor error at index %d", idx);
#define SOAR_LOG(str, ...) (cube_log(str, ##__VA_ARGS__))
